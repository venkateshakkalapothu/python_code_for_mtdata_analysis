# -*- coding: utf-8 -*-
"""
Created on Thu Jul 25 11:38:04 2024

@author: AKKALAPOTHU VENKATESH

Code: CODE FOR APPARENT RESISTIVITY XY AND YX COMPONENTS
"""
...
plt.plot(frequencies, resistivity_xy, marker='o',   linestyle='-', color='b', label='XY')
plt.plot(frequencies, resistivity_yx, marker='o',   linestyle='-', color='g', label='YX')
