...
TIME_PERIOD = np.reciprocal(frequencies)
...
Magnitude_impedance = abs(ZXY)
resistivity = Magnitude_impedance**2 / (omega * u_0)



print("resistivity values :", resistivity)

skin_depth = 503.8*math.sqrt(resistivity*TIME_PERIOD)

print("skin depth values :", skin_depth)
